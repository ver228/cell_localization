...
from cell_localization.trainer import train_segmentation
...
def train(
    ...
    if root_data_dir.is_dir():
        ...
        print(root_data_dir)
        train_flow = FlowCellSegmentation(train_dir,
        ...
        val_flow = FlowCellSegmentation(test_dir,
                        roi_size = roi_size,
                        **flow_args,
                        is_preloaded = is_preloaded
                        ) 
        ...
        train_flow = FlowCellSegmentation(root_data_dir,
                        samples_per_epoch = train_samples_per_epoch,
                        roi_size = roi_size,
                        **flow_args,
        ...
        val_flow = FlowCellSegmentation(root_data_dir,
                        roi_size = roi_size,
                        **flow_args,
    ...
    train_segmentation  (save_prefix,
        model,
        device,
        train_flow,
        val_flow,
